...
public class MpGenerator {
    ...
    public static void main(String[] args) {
       assert (false) : "代码生成属于危险操作，请确定配置后取消断言执行代码生成！";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/shop?serverTimezone=GMT%2B8");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        //strategy.setTablePrefix(new String[] { "user_","student_" });// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.nochange);// 表名生成策略
        //strategy.setInclude(new String[] { "teacher","student" }); // 需要生成的表
